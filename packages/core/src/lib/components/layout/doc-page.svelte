...
<aside class="sticky">
	<div class="sticky top-24 hidden pl-1 xl:block">
...
<div class="mx-auto">
	...
	<main class="mx-auto w-full min-w-0 max-w-[640px] pb-12 2xl:max-w-[960px]" id="main-content">
		<PageHeader {title} {description} {availableSinceVersion} />
