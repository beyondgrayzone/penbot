...
<script>
	import { Textarea, Label, CardContainer, Button } from "@bladocs/core";
</script>
...
<CardContainer>
			<Textarea disabled id="bio" name="bio" placeholder="Tell us about yourself" />
</CardContainer>
